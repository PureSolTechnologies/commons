...
public class FileUtilitiesTest {
	...
	public void testCreateHumanReadableSizeString() {
		...
		assertEquals(new DecimalFormat("#.##").format(2.5) + "kB", FileUtilities.createHumanReadableSizeString(2560));
		assertEquals("1000kB", FileUtilities.createHumanReadableSizeString(1024 * 1000));
		assertEquals("1000MB", FileUtilities.createHumanReadableSizeString(1024 * 1024 * 1000));
	}
