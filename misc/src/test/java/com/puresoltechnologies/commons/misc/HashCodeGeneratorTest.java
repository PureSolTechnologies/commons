...
public class HashCodeGeneratorTest {
	...
	@Test
	public void checkAvailabilityOfMessageDigest() throws NoSuchAlgorithmException {
		String[] cryptoImpls = HashCodeGenerator.getCryptoImpls("MessageDigest");
	...
	@Test
	public void checkAvailabilityOfMessageDigestMD5() throws NoSuchAlgorithmException {
		assertNotNull(MessageDigest.getInstance("MD5"));
	}

	@Test
	public void checkAvailabilityOfMessageDigestSHA() throws NoSuchAlgorithmException {
	...
	@Test
	public void checkAvailabilityOfMessageDigestSHA256() throws NoSuchAlgorithmException {
		assertNotNull(MessageDigest.getInstance("SHA-256"));
	}

	@Test
	public void checkAvailabilityOfMessageDigestSHA384() throws NoSuchAlgorithmException {
		assertNotNull(MessageDigest.getInstance("SHA-384"));
	}

	@Test
	public void checkAvailabilityOfMessageDigestSHA512() throws NoSuchAlgorithmException {
	...
	public void checkSHA256() {
		...
		assertEquals("7f24c25a0a1efc5f2240c6a6c400538c6760681b6522212373afc7c0c6030676", encoder);
	}

	@Test
	public void checkSHA384() {
		String encoder = HashCodeGenerator.getSHA384(SAMPLE_STRING);
		assertEquals("e6890fd85b7d151cc6ba3e809c12a0dcff2c991295499d84383b39acb772a6e1e86a5de7aef79da2d5ce4f79a5fb5b76",
				encoder);
	}
