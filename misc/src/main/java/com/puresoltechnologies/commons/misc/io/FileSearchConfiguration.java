...
public class FileSearchConfiguration implements Serializable, Cloneable {
     ...
     *            a list of directory (location) patterns which are to be
     *            included.
     * @param locationExcludes
     *            a list of directory (location) patterns which are to be
     *            excluded.
     * @param fileIncludes
     *            a list of file patterns which are to be included.
     * @param fileExcludes
     *            a list of file patterns which are to be excluded.
     * @param ignoreHidden
     *            set whether hidden files or directories are ignored or not.
     */
    @JsonCreator
    public FileSearchConfiguration(
	...
	hashCode = Objects.hash(locationIncludes, locationExcludes,
