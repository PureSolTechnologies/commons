...
public class Money extends Number implements Comparable<Money>, Serializable {
     ...
     * amount in the smallest unit for the specified currency! For Dollar it would
     * be Cent for instance.
     */
    private final long amount;

    /**
     * This field contains the fraction of the currency's smallest unit to the major
     * unit.
     */
     ...
     * ratios to each other as specified due to the side condition that the sum of
     * all shares need to be <b>exactly</b> the source amount of money. The error of
     * the share difference is maximal the amount of the smallest possible money
     * amount.
     * 
     * @param ratios
     ...
     * specified.
     * 
     * <b>Attention:</b> It is not guaranteed that all shares have an equal amount
     * due to the side condition that the sum of all shares need to be
     * <b>exactly</b> the source amount of money. The error of the share difference
     * is maximal the amount of the smallest possible money amount.
     * 
     * @param numberOfShares
     *            is the number of shares the current amount of money is split into.
     * @return An array of {@link Money} is returned containing the shares.
     */
	...
	if (!currency.equals(o.currency)) {
	    throw new IllegalArgumentException("Comparing two money values is only supported with same currency, got '"
		    + currency + "' and '" + o.currency + "'.");
	}
	if (fraction != o.fraction) {
	    throw new IllegalArgumentException("Comparing two money values is only supported with same fraction, got '"
     ...
     * 
     * An {@link IllegalStateException} is thrown in case the int value is to small
     * for the amount.
     * 
     ...
     * {@link #getAmount()} <b>divided</b> by {@link #getFraction()}. This is the
     * difference to {@link #intValue()} and {@link #longValue()} where the correct
     * number of amount is returned. Here the result is calculated already with
     * fractions into a floating point number.
     * </p>
     * <p>
